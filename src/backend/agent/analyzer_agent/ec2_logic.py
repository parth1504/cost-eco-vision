...
def generate_ec2_recommendations(resource):
    ...
    if not size_decision_made and cpu_max > 80:
        ...
        recommendations.append({
            ...
            "type": "performance",
            "severity": "high",
            "saving": round(resource.get("monthly_cost", 0) * 0.15, 2) or 14,
    ...
    if not size_decision_made and cpu_avg < 20 and cpu_max > 70:
        ...
        recommendations.append({
            ...
            "type": "performance",
            "severity": "medium",
            "saving": round(resource.get("monthly_cost", 0) * 0.20, 2) or 9,
    ...
    if health.get("status_check_failed_max", 0) > 0:
        ...
        recommendations.append({
            ...
            "type": "performance",
            "severity": "critical",
            "saving": round(resource.get("monthly_cost", 0) * 0.08, 2) or 6,
